...
insert  into `customers`(`customerNumber`,`customerName`,`contactLastName`,`contactFirstName`,`phone`,`addressLine1`,`addressLine2`,`city`,`voivodeship`,`postalCode`,`country`,`salesRepEmployeeNumber`,`creditLimit`) values 
